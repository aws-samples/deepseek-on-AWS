    ...
    try:
        ...
        for ip_str in ip_addresses:
            try:
                ...
                if ip.is_private:  # Property, not method - false positive
                    raise HTTPException(
                        status_code=403,
                ...
                # nosemgrep: python.lang.maintainability.is-function-without-parentheses
                if ip.is_loopback:  # Property, not method - false positive
                    raise HTTPException(
                        status_code=403,
                ...
                # nosemgrep: python.lang.maintainability.is-function-without-parentheses
                if ip.is_link_local:  # Property, not method - false positive
                    raise HTTPException(
                        status_code=403,
                ...
                # nosemgrep: python.lang.maintainability.is-function-without-parentheses
                if ip.is_multicast:  # Property, not method - false positive
                    raise HTTPException(
                        status_code=403,
                ...
                # nosemgrep: python.lang.maintainability.is-function-without-parentheses
                if ip.is_reserved:  # Property, not method - false positive
                    raise HTTPException(
                        status_code=403,
